    ...
    def load_table_data(self, choreographer_id=None):
        ...
        try:
            ...
            if choreographer_id:
                ...
                # Без фильтрации
                query = "SELECT IdChoreographer as 'Номер хореографа', NumberOfGroup as 'Номер группы', DanceStyle as 'Стиль танца' FROM Grouppa"
                cursor.execute(query)
    ...
    def load_table_data(self, group=None):
        ...
        try:
            ...
            if group:
                ...
                # Без фильтрации
                query = "SELECT Id_Schedule as 'Номер занятия', NumberOfGroup as 'Номер группы', DateOfClass as 'Дата занятия', TimeOfClass as 'Время занятия'FROM Schedule"
                cursor.execute(query)
...
if __name__ == "__main__":
    ...
    app.setStyleSheet("""
        /* Основной стиль для окна приложения */
        QWidget {
